			...
			<?php
				...
				if (isset($_GET[success])) {
					...
					<div class="alert alert-success" role="alert" align="center">
						Aviso: la categoria ha sido editada correctamente.
					</div>
					</div>';
				}
				if (isset($_GET[error])) {
              ...
              Lo sentimos: la categoria no ha sido editada correctamente.
						</div>
						</div>';
					}
                      ...
                      <form class="form-horizontal" action="?view=categorias&mode=edit&id=<?php echo $_GET['id']?>" method="POST" enctype="application/x-www-form-urlencoded">
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            ...
                            name="nombre" value="<?php echo $_categorias[$_GET['id']]['nombre']?>">
                          </div>
                        </div>
                        <div class="form-group">
